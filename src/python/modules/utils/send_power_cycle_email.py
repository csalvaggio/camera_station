...
def send_power_cycle_email(station_parameters):
   ...
   message += '\n'
   message += 'A power cycle was completed on the camera attached to this '
   message += 'station.  You should check the operations log to make sure '
   message += 'that image capture has resumed.\n'
   message += '\n'
   message += 'If image capture has not resumed, you may want to consider:\n'
   message += '\n'
